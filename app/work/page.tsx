...
export default function WorkPage() {
  return (
    <>
      <section className="route-hero work-hero">
      ...
      <section className="page-section work-index">
        <div className="project-grid-two">
          {projects.map((project, index) => (
            <ProjectCard key={project.slug} project={project} index={index + 1} large={index < 3} />
          ))}
        </div>
